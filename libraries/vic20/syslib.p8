...
cbm {
    ; Commodore (CBM) common variables, vectors and kernal routines
        ...
        const  uword  Screen    = $1e00     ; to have this as an array[22*23] the compiler would have to support array size > 255
        const  uword  Colors    = $9600     ; to have this as an array[22*23] the compiler would have to support array size > 255
...
vic20 {
        ...
        const ubyte SCREEN_COLOR_OFFSET = $78
